...
return [
    ...
    'edit' => 'تعديل بيانات العميد',
    'delete' => 'حذف العميد',
    'delete_confirmation' => 'هل أنت متأكد من عملية حذف هذ العميد ؟',
    ...
    'label' =>[
        'name' => 'الإسم',
        'firstname_ar' => 'الإسم بالعربي',
        'lastname_ar' => 'اللقب بالعربي',
        'batch' => 'الدفعة',
        'group' => 'الفوج',
        'phone' => 'رقم الهاتف',
        'email' => 'البريد الإلكتروني',
