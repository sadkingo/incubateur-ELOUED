...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">{{ trans('admin.edit') }}</h5>
            <form method="post" action="{{ route('dashboard.admins.update', 'test') }}">
                @method('PUT')
                @csrf
                ...
                <div class="row ">
                    <div class="col-sm-12 col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                            value="{{ $admin->name }}" placeholder="{{ trans('app.placeholder.name') }}">
                        @error('name')
                    ...
                    <div class="col-sm-12 col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"
                            value="{{ $admin->email }}" placeholder="{{ trans('app.placeholder.email') }}">
                        @error('email')
                    ...
                    <div class="col-sm-12 col-md-4 mb-2">
                        ...
                        <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
                            value="{{ $admin->phone }}" placeholder="{{ trans('app.placeholder.phone') }}">
                        @error('phone')
                            <small class="text-danger d-block">
                                {{ $message }}
                            </small>
