...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">{{ trans('commission.dashboard') }} /</span> {{ trans('commission.stat') }}
    </h4>
    <div class="card">
            ...
            <table class="table mb-2">
                <thead>
                    <tr class="text-nowrap">                        
                        ...
                        <th>{{ trans('commission.projet_rejected') }}</th>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-menu" href="{{url('dashboard/commission/'.$commission->id.'/stat')}}" >
