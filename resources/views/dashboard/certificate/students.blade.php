    ...
    <div class="card">
        ...
        <div class="row mb-4">
          ...
          {{-- <div class="my-w-fit-content">
            ...
            {{-- <select class="form-select my-w-fit-content mx-1" id="selectProjectClassification" name="project_classification" aria-label="Default select example">
...
$(document).ready(function() {
        ...
        table = $('#table').DataTable({
          ...
          language: {
            ...
            ajax: {
            url: "{{ route('certificate.students', $certificate->id) }}",
            },
          columns: [
            {data: 'id', name: '#'},
